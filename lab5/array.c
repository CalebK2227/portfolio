...
/**
 * Finds the count of elements in the array that are less than, less than or
 * equal to, equal to, greater than, or greater than or equal to a certain
 * number
...
/**
 * preforms a linear search of the array to find a certain number is in the
 * array
 * @param i temporary values for the array
 * @param index tells if the number is or isnt in the array
 * @return the index
 */
 ...
 * @param tmp temporary value used for switching values
 * @param i temporary value for array
 */
...
/**
 * finds the count of elements in the array that are even
 * @param i temporary value for array
 * @param even the count of even values
...
/**
 * finds the count of elements in the array that are odd
 * @param i temporary value for the array
 * @param odd count of odd values
...
/**
 * finds the count of elements that are divisible by a certain number
 * @param i temporary value for the array
 * @param divisible the count of elements divisible
 * @return the count of elements divisible
 */
int divisible_count(int a[], size_t size, int div) {
	int i;
	int divisible;
	divisible = 0;
	for(i = 0; i < size; i++) {
